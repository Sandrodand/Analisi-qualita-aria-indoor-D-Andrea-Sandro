...
All_data %>% filter(Temperature>46)
...
#--------------Plant Analysis ----------------
clean_devices %>% count(plant_id) %>% arrange(-n)
...
ggsave("HumidityPlot_All_data_byweekday.jpg",plot = HumidityPlot_All_data_byweekday, path = "Plots",height = 7, width = 10)
ggsave("Temperature_All_data_byweekday.jpg",plot = Temperature_All_data_byweekday, path = "Plots",height = 7, width = 10)
ggsave("VocPlot_All_data_byweekday.jpg",plot = VocPlot_All_data_byweekday, path = "Plots",height = 7, width = 10)
ggsave("CoPlot_All_data_byweekday.jpg",plot = CoPlot_All_data_byweekday, path = "Plots",height = 7, width = 10)
ggsave("Co2Plot_All_data_byweekday.jpg",plot = Co2Plot_All_data_Co2_byweekday, path = "Plots",height = 7, width = 10)
ggsave("pm25Plot_All_data_byweekday.jpg",plot = pm25Plot_All_data_byweekday, path = "Plots",height = 7, width = 10)


ggsave("Devices_map_plot.jpg",plot = Devices_map_plot, path = "Plots",height = 7, width = 10)
ggsave("Devices_eumap_plot.jpg",plot = Devices_eumap_plot, path = "Plots",height = 7, width = 10)
